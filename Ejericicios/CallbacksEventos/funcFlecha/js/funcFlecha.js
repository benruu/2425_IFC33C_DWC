...
const carlos = new usuario("Carlos")
// Llamada directa desde el objeto
carlos.saludarTradicional(); // "Hola, mi nombre es Carlos."
carlos.saludarFlecha(); // "Hola, mi nombre es undefined." (o similar)

// Llamada desde una variable externa
let saludarExterno = carlos.saludarTradicional;
// aqui deberia usar el bind de esta manera
let saludarExterno1 = carlos.saludarTradicional.bind(carlos);
...
let saludarFlechaExterno = carlos.saludarFlecha;
saludarFlechaExterno(); // "Hola, mi nombre es undefined."